...
return [
    ...
    'create_summary' => 'Fill in the form to create a new permission, remember that these permissions are created for specific tasks that are then assigned to roles.',
    'users' => 'Users',
