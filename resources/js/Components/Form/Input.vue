...
const buildInputValue = () => {
    ...
    if (typeof modelValue.value === "object" && modelValue.value !== null) {
        if (translation.value) {
            if (!modelValue.value.hasOwnProperty("translations")) {
            ...
            if (modelValue.value.translations.hasOwnProperty(selectedLocale.value)) {
                inputValue.value = modelValue.value.translations[selectedLocale.value].hasOwnProperty(attrs.name)
                                   ? modelValue.value.translations[selectedLocale.value][attrs.name] : value.value
                                                                                                       ? value.value
                                                                                                       : "";
            } else {
                inputValue.value = "";
