        ...
        <table class="table
            ...
            <thead class="uppercase tracking-wider text-xs font-semibold">
                <tr>
                    ...
                    <th v-if="showActions()"
                        class="bg-skin-inverted dark:bg-skin-inverted-dark px-5 py-3 text-center w-48">
                        {{ __("actions") }}
                    </th>
                </tr>
            </thead>
                    ...
                    <td :colspan="countColumns()">
                        <div class="mx-4 my-2">
                            <input v-model="searchInput"
                                   ...
                                   class="w-full text-sm sm:w-1/2 dark:bg-inherit border-gray-100 dark:border-gray-600 text-skin-base dark:text-skin-base-dark focus:border-gray-200 focus:ring focus:ring-gray-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                   type="text">
                        </div>
                    </td>
                </tr>
