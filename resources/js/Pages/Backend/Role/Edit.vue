...
export default {
    layout: (h, page) => h(MainLayout, {
        ...
        icon: "key",
        bc: [{label: "roles", route: "admin.roles.index"}, {label: "edit"}]
    }, () => page)
};
</script>
<script setup>
...
const props = defineProps({
    permissions: Array, translations: Object, selectedPermissions: Array, role: Object, errors: Object
});

const {
          translations, role, selectedPermissions
      } = toRefs(props);
const form = reactive({
    name: role.value.name, selectedPermissions: selectedPermissions.value, ...translations.value
});
