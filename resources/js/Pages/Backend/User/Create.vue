...
export default {
    layout: (h, page) => h(MainLayout, {
        title: "users",
        icon: "users",
        bc: [{label: "users", route: "admin.users.index"}, {label: "create"}]
    }, () => page)
};
</script>
<script setup>
...
defineProps({
    roles: Array, errors: Object
});

const selectedRoles = ref([]);
const form = reactive({
    name: null, email: "", selectedRoles: selectedRoles.value, password: "", password_confirmation: ""
});
const submit = () => {
