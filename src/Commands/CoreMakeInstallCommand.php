...
class CoreMakeInstallCommand extends Command
{
	...
	public static function files(): array
	{
		return [
			...
			['from' => resource_path('lang/en/contact.php'), 'to' => 'resources/lang/en/contact.php.stub'],
			...
			['from' => resource_path('lang/es/contact.php'), 'to' => 'resources/lang/es/contact.php.stub'],
			...
			['from' => base_path('config/filesystems.php'), 'to' => 'config/filesystems.php.stub'],
			
			// App
			['from' => app_path('Models/User.php'), 'to' => 'app/Models/User.php.stub'],
			[
				'from' => app_path('Providers/AuthServiceProvider.php'),
				'to' => 'app/Providers/AuthServiceProvider.php.stub',
			],
			[
				'from' => app_path('Providers/AppServiceProvider.php'),
				'to' => 'app/Providers/AppServiceProvider.php.stub',
			],
			[
				'from' => app_path('Http/Controllers/MainController.php'),
				'to' => 'app/Http/Controllers/MainController.php.stub',
			],
			[
				'from' => app_path('Http/Requests/ContactRequest.php'),
				'to' => 'app/Http/Requests/ContactRequest.php.stub',
			],
			[
				'from' => app_path('Mail/ContactMail.php'),
				'to' => 'app/Mail/ContactMail.php.stub',
			],
			
			// Routes
			['from' => base_path('routes/api.php'), 'to' => 'routes/api.php.stub'],
	...
	{
		if(file_exists($fileOne) and file_exists($fileTwo)) {
